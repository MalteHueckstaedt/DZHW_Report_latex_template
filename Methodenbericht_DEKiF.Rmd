...
df$Researcher_Role <- df$Researcher_Role %>%
  recode("Antragsteller"= "Teilprojektleiter/Antragsteller",
         "Auslädnischer Sprecher/Antragsteller"= "Teilprojektleiter/Antragsteller",
         "Ausländische Sprecher/Antragsteller"= "Teilprojektleiter/Antragsteller",
         "ausländischer Sprecher/Antragsteller"= "Teilprojektleiter/Antragsteller",
         "Ausländischer Sprecher/Antragsteller"= "Teilprojektleiter/Antragsteller",
         "AusländischerSprecher/Antragsteller"= "Teilprojektleiter/Antragsteller",
         "Gastgeber/Antragsteller"= "Teilprojektleiter/Antragsteller",
         "Leiter/Antragsteller"= "Sprecher",
         "Sprecher & Teilprojektleiter"= "Sprecher",
         "Sprecher/Antragsteller"="Sprecher",
         "Stellvertreter/Antragsteller"="Teilprojektleiter/Antragsteller",
         "Teilprojektleiter"="Teilprojektleiter/Antragsteller",
         "Stellvertretender Sprecher"="Sprecher",
         "stellvertretender Sprecher/Antragsteller"="Teilprojektleiter/Antragsteller")
...
Sprecher <- df %>% filter(Researcher_Role=="Sprecher") %>% group_by(ID) %>% sample_n(1)
