...
library(kableExtra)
library(pander)
df <- read_excel("/Users/maltehueckstaedt/Google Drive/GitHub/AP6/data/final_data/zofar_df.xlsx", col_types = rep("text",12))
...
Am 16.09.2020 wurden initial die n=15.595 Zielpersonen per Email mit individualisierten Einladungslinks zum Websurvey eingeladen. Mit n=1.241 Zielpersonen konnte in dieser 1. Charge kein Kontakt aufgenommen werden. Dies war in den allermeisten Fällen auf die auf der Datenbank GEPRIS veralteten aber dennoch weiterhin gelisteten Mailadressen zurückzuführen. Für n=628 Zielpersonen konnten innerhalb von sieben Tagen alternative Kontaktadressen recherchiert werden, für n=613 Zielpersonen konnte kein alternativer Kontakt recherchiert werden. Mit einem Anteil von 4,03% der Zielpersonen der Grundgesamtheit konnte indes kein Kontakt hergestellt werden.
