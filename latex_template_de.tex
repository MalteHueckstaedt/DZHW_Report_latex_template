...
\documentclass[a4paper,10pt,twoside,cleardoubleempty]{article}
...
\usepackage[top=2cm,bottom=2cm,left=2cm,right=4cm,includeheadfoot]{geometry}
...
\predate{\vfill
        ...
        \flushleft}
\postdate{%
        \hspace*{-6cm}\includegraphics[width=18.36cm]{DZHW_blue_bar.png}\\
        \vspace{0.5cm}
