...
\lfoot{\setlength{\unitlength}{1mm}
            \begin{picture}(0,0)
            \put(0,0){\includegraphics[width=5cm]{FDZ_DZHW.png}}
            \end{picture}}
\rfoot{$short-title$ | \thepage}
...
\postdate{%
        ...
        \vspace{0.5cm}
        \hspace*{1cm}\includegraphics[width=3.7cm]{FDZ_DZHW_blue_bar.png}%
        \hspace*{6.5cm}\includegraphics[width=3.7cm]{BMBF.jpg}%
